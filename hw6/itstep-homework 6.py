...
# print()
#
# st_id = int(input("Choose student ID: "))
#
...
# for student in my_dict["students"]:
#     if student["id"] == st_id:
#         print(f"ID: {st_id}, Name: {student["name"]}, Age: {student["age"]}")
#
#
# for subject in my_dict["subjects"]:
#     print(f"subject: {subject["name"]}, grade: {subject["grades"][str(st_id)]}")
#
